...
const Selectbox = ({ changeToPage, changeToSection, step = "first" }) => {
  ...
  const textbox1 = pageData[0].textBox1; // הילוכים
  const textbox2 = pageData[0].textBox2; // העברה
      ...
      <div className="divBoxWrapper">
        ...
        >
          ...
          >
            <path
              className="boxBack"
              d="M14 100.596H327.979V315.849H14V100.596Z"
            />

            <g className="lid lidLeft">
              <path
                className="lidFill"
                d="M14.5615 100.596L67.1975 24.0135H170.766V100.596H14.5615Z"
                stroke="#141414"
                strokeWidth="4"
              />
            </g>
            ...
            <g className="lid lidRight">
              <path
                className="lidFill"
                d="M326.369 100.596L274.335 24.0135H170.766V100.596H326.369Z"
                stroke="#141414"
                strokeWidth="4"
              />
            </g>
            ...
            <path
              className="boxBody"
              d="M32.0626 96.3879H309.503C321.894 96.3879 331.981 106.474 331.981 118.865V297.613C331.981 310.004 321.894 320.091 309.503 320.091H32.0626C19.6718 320.091 9.58545 310.004 9.58545 297.613V118.865C9.58545 106.474 19.6718 96.3879 32.0626 96.3879Z"
              stroke="#141414"
              strokeWidth="8"
            />
