...
const  GearBox= ({changeToPage,changeToSection})=> {
...
<div className="boxContainer" id="box-1"         onClick={nextPage}
>
  <svg viewBox="0 0 342 420" fill="none" xmlns="http://www.w3.org/2000/svg" className="mainSvg">
    <path d="M14 100.596H327.979V315.849H14V100.596Z" fill="#B3862B"/>
    
    <g className="risingItem">
       <circle cx="171" cy="150" r="40" fill="none" stroke="#141414" strokeWidth="4" strokeDasharray="10 5"/>
       <path d="M171 120V180M141 150H201" stroke="#141414" strokeWidth="6" strokeLinecap="round"/>
    </g>
    ...
    <rect x="245" y="254" width="61" height="45" rx="8" fill="#A4704C" stroke="#111111" strokeWidth="4"/>
    <text x="275" y="288" textAnchor="middle" fontFamily="Arial" fontSize="26" fontWeight="bold" fill="black">צ</text>

    <text className="boxLabel" x="50%" y="370" textAnchor="middle" fontFamily="Arial" fontSize="30" fontWeight="bold" fill="black">תיבת הילוכים</text>
  </svg>
</div>
...
<svg viewBox="0 0 342 450" fill="none" xmlns="http://www.w3.org/2000/svg" className="main-svg">
    <path d="M14 100.596H327.979V315.849H14V100.596Z" fill="#B3862B"/>
    
    <g id="item-out" className="floating-item">
        <circle cx="171" cy="180" r="30" fill="#141414" />
        <path d="M171 140V155M171 205V220M211 180H196M146 180H131" stroke="#141414" strokeWidth="8" strokeLinecap="round"/>
        </g>

    <g id="lid-left" className="lid">
        <path d="M14.5615 100.596L67.1975 24.0135H170.766V100.596H14.5615Z" fill="#D39E33" stroke="#141414" strokeWidth="3"/>
    </g>
    <g id="lid-right" className="lid">
        <path d="M326.369 100.596L274.335 24.0135H170.766V100.596H326.369Z" fill="#D39E33" stroke="#141414" strokeWidth="3"/>
    </g>

    <path d="M32.0626 96.3879H309.503C321.894 96.3879 331.981 106.474 331.981 118.865V297.613C331.981 310.004 321.894 320.091 309.503 320.091H32.0626C19.6718 320.091 9.58545 310.004 9.58545 297.613V118.865C9.58545 106.474 19.6718 96.3879 32.0626 96.3879Z" fill="#D39E33" stroke="#141414" stroke-width="8"/>
    
    <text id="box-label" x="50%" y="380" textAnchor="middle" fontFamily="sans-serif" fontSize="28" fontWeight="bold" fill="black">{textbox2}</text>
  </svg>
{/* 
